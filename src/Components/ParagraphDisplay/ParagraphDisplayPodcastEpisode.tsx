...
export const ParagraphDisplayPodcastEpisode = (props: ParagraphDisplayPodcastEpisodeProps) {
  const {data, view_mode, key} = props;
  return (
    <ErrorBoundary>
      <PodcastEpisodeDisplay data={data.field_episode_ref} view_mode={view_mode} />
    </ErrorBoundary>
  )
