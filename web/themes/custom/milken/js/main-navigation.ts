...
templateObject[0].innerHTML = `
      <div class="col col-lg-3 col-sm-12 menucito-About">
        <h5>About</h5>
...
templateObject[1].innerHTML = `
    <div class="col col-lg-3 col-sm-12 menucito-Centers">
...
templateObject[2].innerHTML = `
  <div class="col col-lg-3 col-sm-12 menudelcentro" >
  <h5>EXPLORE</h5>
      <ul class="menu-content">
      <li>
...
templateObject[3].innerHTML = `
        <div class="col col-xs-12 col-lg-3 col-sm-12">
...
customElements.define('milken-main-navigation',
  ...
  class extends HTMLElement {
    ...
    constructor() {
      ...
      document.getElementById('menu-reveal').addEventListener('click', this.showHide.bind(this));
    }
  }
);
